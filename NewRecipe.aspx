...
<body>
    ...
    <div>
        ...
        <p class="auto-style1" style="text-align: center">
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" Height="50px" Width="424px" DefaultMode="Insert">
                <Fields>
